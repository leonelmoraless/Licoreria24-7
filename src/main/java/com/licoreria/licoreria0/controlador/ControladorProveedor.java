...
public class ControladorProveedor {
    ...
    // Muestra la pagina principal de los proveedores, la Lista de proveedores
    // registrados y editar proveedores
    ...
    // Metodo para registrar un nuevo proveedor usando el facade para validar y
    ...
    public String eliminarProveedor(@RequestParam("id") Long idProveedor, RedirectAttributes attributes) {
        try {
